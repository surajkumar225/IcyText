...
const About = () => {
  ...
  return (
    <div className="contAbout">
        <h4>IcyText is a React Application for managing personal notes on the cloud</h4>
        <hr />
        ...
        <button className='connect2 mx-5'><a href="https://twitter.com/surajk257" target="_blank"><i className="fa-brands fa-twitter" id='twit'></i> Twitter </a></button>
